                      ...
                      children: [
                        Padding(
                          ...
                          child: SizedBox(
                            ...
                            child: CircleAvatar(
                              ...
                              child: Center(
                                child: Image.asset("assets/images/baby.jpg",fit: BoxFit.cover,),
                                // child: TextButton(
                                //   onPressed: (){},
                        ...
                        Column(
                          ...
                          children: [
                            Row(
                              children: const [
                                Text("@Salim Ali", style: TextStyle(fontSize: 16, color: Colors.black, fontWeight: FontWeight.w600),),
                                SizedBox(
                                  width: 5,
                                ),
                                Text("art!", style: TextStyle(fontSize: 16, color: Colors.black, fontWeight: FontWeight.w500),),
                              ],
                            ),
                            const SizedBox(
                              height: 5,
